    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          <button
            onClick={() => onClose()}
            className="fixed top-20 right-8 z-[110] w-12 h-12 rounded-xl flex items-center justify-center text-white/40 hover:text-[#FF6B6B] hover:bg-[#FF6B6B]/10 transition-all shadow-2xl bg-white/5 border border-white/10 cursor-pointer"
          >
            <X className="w-6 h-6" />
          </button>
