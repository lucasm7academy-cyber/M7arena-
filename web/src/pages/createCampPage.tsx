...
import { 
  Plus, Image as ImageIcon, Users, Trophy, Calendar, 
  Layout, ArrowLeft, Save,
  Upload, X, CheckCircle2, Settings2, ChevronRight,
  Check, AlertCircle, Play,
  Diamond, Copy
} from 'lucide-react';
...
import { compressImageFromBase64, compressImage, uploadBase64ToStorage, processTournamentImages } from '../features/campeonatos/domain/imagem';
import { FormCriarCampeonato } from '../features/campeonatos/components/FormCriarCampeonato';
          ...
          {activeTab === 'create' ? (
            ...
            >
              ...
              >
                ...
                <FormCriarCampeonato formData={formData} setFormData={setFormData} handleInputChange={handleInputChange} handleFileChange={handleFileChange} orgInputRef={orgInputRef} bannerInputRef={bannerInputRef} orgPhotoInputRef={orgPhotoInputRef} />
