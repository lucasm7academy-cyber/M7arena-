                        ...
                        return teamMatches.map(
                          (match: any, mIdx: number) => {
                            ...
                            return (
                              <div
                                key={mIdx}
                                className="flex items-center justify-between p-3 sm:p-4 rounded-lg border border-white/5 bg-[#08080a]"
                              >
                                <div className="flex items-center gap-3.5">
                                  ...
                                  <div>
                                    <p className="text-[10px] font-black text-white/40 uppercase tracking-widest flex items-center gap-1.5 flex-wrap">
                                      ...
                                      {match.irregular && (
                                        <span
                                          className="text-[8px] font-black uppercase text-amber-400 bg-amber-400/10 px-1.5 py-0.5 border border-amber-400/30 tracking-widest rounded-md"
