...
export const MeusJogosPendentes = () => {
  ...
  return (
    <motion.div
      ...
      className="w-full rounded-xl sm:rounded-2xl border border-white/10 bg-[#08080a] shadow-2xl p-3 sm:p-6 transition-all"
    >
      <div
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 sm:gap-3">
              <h3 className="text-base sm:text-xl font-black uppercase tracking-wider text-white leading-none">
                Meus Jogos Pendentes
              </h3>
              <ChevronDown
                className={`w-5 h-5 sm:w-6 sm:h-6 text-white/30 transition-transform duration-300 ${isPendingMatchesOpen ? "" : "-rotate-90"}`}
              />
            </div>
            <p
              className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] mt-1 sm:mt-2"
              style={{ color: campeonato.themeColor }}
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-full flex flex-col md:grid md:grid-cols-[160px_1fr_160px] items-center gap-3 sm:gap-4 px-3 sm:px-6 py-3 sm:py-4">
                      ...
                      {/* BOTÃO DE AÇÃO: LATERAL NO DESKTOP, LARGURA COMPLETA NO MOBILE */}
                      <div className="w-full md:w-[160px] shrink-0 flex flex-col justify-center items-stretch md:border-l md:border-white/10 md:pl-4 pt-2.5 md:pt-0 border-t border-white/5 md:border-t-0">
                        {amITheProposer ? (
                          <div className="w-full py-2 sm:py-2.5 px-3 rounded-xl bg-white/5 border border-white/10 text-white/40 flex items-center justify-center gap-1.5 text-[10px] font-black uppercase tracking-wider">
