...
export const AdminCriarJogo = () => {
  ...
  return (
    <div className="w-full rounded-2xl border border-white/10 bg-[#08080a] shadow-2xl p-4 sm:p-6 flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <button
        ...
        className="px-8 py-3.5 bg-white text-black font-black uppercase tracking-widest text-xs rounded-xl hover:scale-105 active:scale-95 transition-all shadow-xl cursor-pointer"
      >
        Criar Novo Jogo
      </button>
    </div>
