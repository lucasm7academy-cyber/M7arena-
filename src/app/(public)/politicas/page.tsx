  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white py-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          <h1 className="text-5xl font-black text-white uppercase tracking-tighter mb-4 font-headline">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-white/5 border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-black text-[#FFB700] uppercase tracking-tight mb-4 font-headline">
              1. Respeito Mútuo
            </h2>
