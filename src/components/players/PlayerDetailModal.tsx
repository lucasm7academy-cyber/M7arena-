...
export const getIconeUrl = (iconeId: number) => `https://ddragon.leagueoflegends.com/cdn/14.24.1/img/profileicon/${iconeId}.png`;
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          {(jogador.timeLogo || jogador.timeTag) && (
            <div
              ...
              onClick={() => { if (jogador.timeId) { onClose(); router.push(`/times/${jogador.timeId}`); } }}
            >
              <div
