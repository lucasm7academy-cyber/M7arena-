...
**Última atualização:** 18/08/2026 01:20 — por `gemini`
...
|---|---|---|
| 18/08/2026 01:20 | gemini | Refinamento das bordas dos cards da pagina Lobby (Lobby.tsx) de 1.5px/gradiente forte para 1px com gradiente de baixa opacidade, eliminando qualquer vazamento/aparencia de triangulo diagonal sobre a imagem. Rebuild e deploy na VPS dev.m7arena.pro. <br>_tocou: `web/src/pages/Lobby.tsx`_ |
