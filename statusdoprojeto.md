...
**Última atualização:** 20/08/2026 00:23 — por `gemini`
...
|---|---|---|
| 20/08/2026 00:23 | gemini | Redesign completo Cut-Edge aplicado na página de detalhes do campeonato (CampeonatoDetalhes.tsx) e todos os seus subcomponentes, modais e abas <br>_tocou: `web/src/pages/CampeonatoDetalhes.tsx`_ |
