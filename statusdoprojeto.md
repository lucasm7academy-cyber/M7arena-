...
**Última atualização:** 18/08/2026 01:18 — por `gemini`
...
|---|---|---|
| 18/08/2026 01:18 | gemini | Correcao de alinhamento e flex stretch do container duplo chanfrado na Lobby (Lobby.tsx) eliminando preenchimento indevido do gradiente. Adicao da iluminacao ambiente suave global no LayoutWrapper.tsx e index.css para todas as abas do app (Perfil, Jogar, Inicio, Campeonatos, etc.). <br>_tocou: `web/src/pages/Lobby.tsx`, `web/src/components/layout/LayoutWrapper.tsx`, `web/src/index.css`_ |
