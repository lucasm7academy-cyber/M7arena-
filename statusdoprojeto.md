...
| 15/08/2026 16:27 | gemini | Modernização visual completa do Painel Admin (Admin.tsx, FinanceiroDashboard, RevisaoPartidas, SaquesPix, AdminCargos, AdminContatos, AdminPunicoes): aplicado dark glassmorphism elevado (substituindo o fundo flat pitch-black), tipografia em alto contraste com tons zinc, badges e acentos em gradiente dourado M7. Build validado localmente (tsc exit 0) e deploy efetuado na VPS dev.m7arena.pro. <br>_tocou: `web/src/pages/Admin.tsx`, `web/src/pages/AdminCargos.tsx`, `web/src/pages/AdminContatos.tsx`, `web/src/pages/AdminPunicoes.tsx`, `web/src/components/admin/FinanceiroDashboard.tsx`, `web/src/components/admin/RevisaoPartidas.tsx`, `web/src/components/admin/SaquesPix.tsx`_ |
| 15/08/2026 16:23 | gemini | Ajustadas as bordas dos botoes e cards do menu superior da sala em SalaMod1.tsx para o padrao angular e chanfrado (cut-corners) do eSports/M7 Arena. Rebuild e deploy na VPS dev.m7arena.pro concluidos. <br>_tocou: `web/src/pages/SalaMod1.tsx`_ |
| 15/08/2026 16:18 | gemini | Redesenhado o menu/topbar superior das salas (SalaMod1.tsx): removida imagem do Ryze, implementado visual dark glassmorphism com glow sutil, badges de modo/estado com status dot dinâmico, card de modalidade (Casual/MC) e botões refinados. Build e deploy na VPS dev.m7arena.pro concluídos. <br>_tocou: `web/src/pages/SalaMod1.tsx`_ |
