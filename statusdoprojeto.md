...
**Última atualização:** 18/08/2026 01:23 — por `gemini`
...
|---|---|---|
| 18/08/2026 01:23 | gemini | Remocao de fundos e overlays opacos (bg-black/90, bg-[#050505], bg-background) de Perfil, Jogar, Campeonatos, Minhas Partidas, Politicas e Streamers, e aumento da intensidade/espalhamento das luzes de fundo ambiente global no LayoutWrapper.tsx. Deploy na VPS dev.m7arena.pro. <br>_tocou: `web/src/components/layout/LayoutWrapper.tsx`, `web/src/pages/perfil.tsx`, `web/src/pages/Jogar.tsx`, `web/src/pages/campeonatos.tsx`, `web/src/pages/CampeonatoDetalhes.tsx`, `web/src/pages/MinhasPartidas.tsx`, `web/src/pages/Politicas.tsx`, `web/src/pages/Streamers.tsx`_ |
