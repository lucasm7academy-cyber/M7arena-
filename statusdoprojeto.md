...
**Última atualização:** 18/08/2026 01:44 — por `gemini`
...
|---|---|---|
| 18/08/2026 01:44 | gemini | Ajuste dos poligonos _INNER para 13.8px nos cards (CUT_FRAME_INNER), 8.8px nos botoes (CUT_BUTTON_INNER) e 5.8px nos badges (CUT_BADGE_INNER), garantindo borda visivel, nitida e encorpada em todos os cantos cortados. Deploy realizado na VPS dev.m7arena.pro. <br>_tocou: `DESIGNDOPROJETO.MD`, `web/src/components/layout/LayoutWrapper.tsx`, `web/src/pages/Lobby.tsx`, `web/src/pages/campeonatos.tsx`, `web/src/pages/players.tsx`, `web/src/pages/recrutamento.tsx`, `web/src/pages/Jogar.tsx`, `web/src/components/partidas/ModaisElegibilidade.tsx`, `web/src/components/partidas/ChatDaSala.tsx`, `web/src/components/ui/CutCard.tsx`, `web/src/components/partidas/CardJogador.tsx`, `web/src/components/partidas/VagaSlot.tsx`, `web/src/pages/SalaMod1.tsx`, `web/src/pages/CampeonatoDetalhes.tsx`_ |
| 18/08/2026 01:40 | gemini | Calibracao trigonometrica da formula dos poligonos _INNER (C_inner = C_outer - 3.414 * t) para 10.6px nos cards, 5.6px nos botoes e 2.6px nos badges, garantindo espessura de borda 100% uniforme (exatos 1px no chanfro diagonal e nas laterais retas). Deploy bem-sucedido na VPS dev.m7arena.pro. <br>_tocou: `DESIGNDOPROJETO.MD`, `web/src/components/layout/LayoutWrapper.tsx`, `web/src/pages/Lobby.tsx`, `web/src/pages/campeonatos.tsx`, `web/src/pages/players.tsx`, `web/src/pages/recrutamento.tsx`, `web/src/pages/Jogar.tsx`, `web/src/components/partidas/ModaisElegibilidade.tsx`, `web/src/components/partidas/ChatDaSala.tsx`, `web/src/components/ui/CutCard.tsx`, `web/src/components/partidas/CardJogador.tsx`, `web/src/components/partidas/VagaSlot.tsx`, `web/src/pages/SalaMod1.tsx`, `web/src/pages/CampeonatoDetalhes.tsx`_ |
| 18/08/2026 01:35 | gemini | Correcao da formula dos poligonos _INNER (CUT_FRAME_INNER, CUT_BUTTON_INNER, CUT_BADGE_INNER) em todos os arquivos (DESIGNDOPROJETO.MD, LayoutWrapper.tsx, Lobby.tsx, campeonatos.tsx, players.tsx, recrutamento.tsx). O ponto 0 100% estava omitido, o que fazia o CSS tracar uma diagonal do canto inferior direito para o superior esquerdo criando o triangulo pintado indesejado. Build e deploy bem-sucedidos em dev.m7arena.pro. <br>_tocou: `DESIGNDOPROJETO.MD`, `web/src/components/layout/LayoutWrapper.tsx`, `web/src/pages/Lobby.tsx`, `web/src/pages/campeonatos.tsx`, `web/src/pages/players.tsx`, `web/src/pages/recrutamento.tsx`_ |
